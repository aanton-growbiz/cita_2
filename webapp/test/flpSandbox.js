		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Citas Médicas",
									"targetURL": "#compensarcitasmedicas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compensarcitasmedicas-display": {
								"semanticObject": "compensarcitasmedicas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=compensar.citas.medicas",
									"url": sap.ui.require.toUrl("compensar/citas/medicas")
								}
							}
						}
					}
